...
xlsxFileName = '2025-02-10 - Model List v1.xlsx'
sheetName = 'PyTorchOnnxOpAnalysis'
currVenvPython = 'C:\\Users\\Local_Admin\\Downloads\\Kshitij\\Repos\\optimum\\venv\\Scripts\\python.exe'
...
for rp in repoPaths:
    ...
    cmd = '%s %s %s %s' % (currVenvPython, '-m optimum.exporters.onnx.__main__ -m', rp, rpOnnxLoc)
